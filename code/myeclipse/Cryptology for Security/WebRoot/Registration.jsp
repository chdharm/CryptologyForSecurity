...
<form action="./RegistrationAction" method="post" name="register" onSubmit="return validate()">
 ...
 <table align="left" width=70%><a href="<%=request.getContextPath() + "/login.jsp"%>">HOME</a>
